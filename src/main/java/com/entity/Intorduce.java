...
public class Intorduce  implements Serializable{
    private Integer iid;
    ...
    public String toString() {
        return "Intorduce{" +
                "iid=" + iid +
                ", pid=" + pid +
                ", introduces1='" + introduces1 + '\'' +
                ", introduces2='" + introduces2 + '\'' +
                ", introduces3='" + introduces3 + '\'' +
                ", introduces4='" + introduces4 + '\'' +
                ", introduces5='" + introduces5 + '\'' +
                '}';
    }
}